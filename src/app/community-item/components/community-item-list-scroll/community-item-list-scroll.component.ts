...
@Component({
  selector: 'app-community-item-list-scroll',
  templateUrl: './community-item-list-scroll.component.html',
  styleUrls: ['./community-item-list-scroll.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CommunityItemListScrollComponent implements OnInit, OnDestroy, AfterViewInit {
  @Input() user: User;
